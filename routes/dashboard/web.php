...
Route::group(
    ...
    function () {
        ...
        Route::prefix('dashboard')->name('dashboard.')->middleware(['auth' => 'web'])->group(function () {
            ...
            Route::get('/programs/duplicate/{id?}', 'ProgramController@duplicate')->name('programs.duplicate');


            Route::resource('days', 'DayController')->except(['show']);
            Route::get('/days/duplicate/{id?}', 'DayController@duplicate')->name('days.duplicate');

            Route::resource('breakfasts', 'BreakfastController')->except(['show']);
            Route::get('/breakfasts/duplicate/{id?}', 'BreakfastController@duplicate')->name('breakfasts.duplicate');

            Route::resource('dinners', 'DinnerController')->except(['show']);
            Route::get('/dinners/duplicate/{id?}', 'DinnerController@duplicate')->name('dinners.duplicate');


            Route::resource('launchs', 'LaunchController')->except(['show']);
            Route::get('/launchs/duplicate/{id?}', 'LaunchController@duplicate')->name('launchs.duplicate');

            Route::resource('snacks', 'SnackController')->except(['show']);
            Route::get('/snacks/duplicate/{id?}', 'SnackController@duplicate')->name('snacks.duplicate');
            ...
            Route::resource('subscribes', 'SubscribeController')->except(['show']);
            Route::resource('orders', 'OrderController')->except(['show']);
            Route::get('orders/export', 'OrderController@export_invoices')->name('orders.export_orders');
            #Cart
