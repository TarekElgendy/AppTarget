...
class ProductResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'MainPrice' => $this->price, //value  ($this->price - $this->discount)
            'discount' =>   $this->discount == null ? 0 : $this->discount, //value db
            'FinalPrice' => $this->Total, //value  ($this->price - $this->discount)
            'stock' => $this->Total,
            'AvgRate' => $this->AvgRate,

            'country' => $this->provenance->title ?? "",
            'country_flag' => $this->provenance->image_path ?? "",
            'provenance_description' => $this->provenance->description ?? "",
