...
$headerCarts = App\Cart::where('customer_id', authCustomer()->id)->latest()->get();
}
@endphp
    ...
    <div class="actions-mobile d-flex align-items-center">
        <div class="btn-login-downz">
            ...
            <ul class="menu-logins">
                ...
                <li class="a-d"><a href="{{route('customer.profile.orders')}}"> <i class="fas fa-clipboard-list"></i>
                ...
                <li class="btn-newaccount">
                    <a rel="alternate" class="langs" hreflang="ar" data-toggle="tooltip" data-placement="bottom"
                        ...
                        <i class="fa fa-globe"></i>@lang('site.english')</a></li>
                @elseif(LaravelLocalization::getCurrentLocale()=='en')
                <li class="btn-newaccount">
                    <a rel="alternate " class="langs" hreflang="ar" data-toggle="tooltip" data-placement="bottom"
                        title="" href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}">
                        <i class="fa fa-globe"></i> @lang('site.arabic') </a> </li>
                @endif
        ...
        <div class="block-cart">
            ...
            <div class="menu-cart">
                ...
                <a href="{{route('customer.checkout.index')}}" class="title text-center"> @lang('site.checkout') </a>
            </div>
            @else
            <a href="javascript:void(0)" class="cartsho-link"><i class="fas fa-shopping-cart"></i> <span
