...
<!-- //END => Breadcrumb -->
<!-- START => Page Signup -->
<section class="page-signup pt-5 pb-5" style="background-image: url(assets/imgs/bg-catgs.jpg);">
    <div class="container">
        <div class="signup-form">
            ...
            <form class="theme-form" action="{{route('customer.register.post')}}" method="post"
                    ...
                    <div class="form-group text-center my-4">
                        <div class="custom-control custom-checkbox border-0">
                            ...
                            <label class="custom-control-label" for="customCheck3">
                                I agree to CUTZ, <a href="" target="_blank">Terms and services</a>, <a href=""
                                    target="_blank">Privacy policy</a>.
                                and <a href="" target="_blank">Content policy</a></label>
                        </div>
                    </div>
                    <div class="form-group text-center">
                        <button class="btn-signup">@lang('site.create Account')</button>
                    </div>
                    {{-- <div class=" form-group"><input type='submit' class="btn-started"
                            value="@lang('site.create Account')">
                    </div> --}}
                </div>
            </form>
            <hr>
