...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('site.days')</li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title" style="margin-bottom: 15px">@lang('site.days')
                    <small>
                        @lang('site.total_search')
                        ( {{  count($days) }} )
                    </small></h3>
                <form action="{{ route('dashboard.days.index') }}" method="get">
                    <div class="row">
                        ...
                        <div class="col-md-4 {{$section_add=='close'?'hidden':''}}">
                            @if (auth()->user()->hasPermission('create_days'))
                            <a href="{{ route('dashboard.days.create') }}" class="btn btn-primary"><i
                ...
                <table class="table table-hover" id="data_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if (auth()->user()->hasPermission('update_days'))
                                <a href="{{ route('dashboard.days.edit', $day->id) }}"
                                ...
                                <a href="#" class="btn btn-info btn-sm disabled"><i class="fa fa-edit"></i>
                                    @lang('site.edit')</a>
                                @endif
                                @if (auth()->user()->hasPermission('delete_days'))
                                <form action="{{ route('dashboard.days.destroy', $day->id) }}" method="post"
