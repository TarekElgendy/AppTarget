        ...
        <div class="row invoice-info">
            <div class="col-sm-12 invoice-col">
                <address>
                    ...
                    <b> @lang('site.programs') </b>: {{ $order->program->title??"" }}>
                    {{ $order->collection->title??"" }}
                    <b> @lang('site.date') </b>: {{ $order->date_subscription ??""}} <br>
                </address>
            </div>
        </div>
    </div>
        ...
        <div class="row invoice-info">
            <div class="col-sm-12 invoice-col">
                <address>
                    ...
                    <b> @lang('site.breakfasts') </b>: {{ $order->breakfast->title??"" }}
                    <b> @lang('site.notes') </b>: {{ $order->breakfast_note??"" }}
        ...
        <div class="row invoice-info">
            <div class="col-sm-12 invoice-col">
                <address>
                    ...
                    <b> @lang('site.launchs') </b>: {{ $order->launch->title??"" }}
                    <b> @lang('site.notes') </b>: {{ $order->launch_note??"" }}
        ...
        <div class="row invoice-info">
            <div class="col-sm-12 invoice-col">
                <address>
                    ...
                    <b> @lang('site.dinners') </b>: {{ $order->dinner->title??"" }}
                    <b> @lang('site.notes') </b>: {{ $order->dinner_note??"" }}
        ...
        <div class="row invoice-info">
            <div class="col-sm-12 invoice-col">
                <address>
                    ...
                    <b> @lang('site.snacks') </b>: {{ $order->snack->title??"" }}
                    <b> @lang('site.notes') </b>: {{ $order->snack_note??"" }}
