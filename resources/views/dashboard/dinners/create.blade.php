    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form action="{{ route('dashboard.dinners.store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('post') }}
                    ...
                    <div class="form-group">
                        ...
                        <textarea required="required" name="{{ $locale }}[description]" id="" class="form-control "
