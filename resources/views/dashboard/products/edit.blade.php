...
<div class="content-wrapper">
        ...
        <div class="box box-primary">
            ...
            <div class="col-md-3">
                ...
                <select name="measr_unit" class="form-control">
                    <option value="per_unit"  {{$product->measr_unit=='unit'?'selected':''}}>@lang('site.per_unit')</option>
                    <option value="weight" {{$product->measr_unit=='weight'?'selected':''}} >@lang('site.per_weight')</option>
                </select>
             </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="serve_number" min="1"   class="form-control" value="{{$product->serve_number}}">
            </div>
            ...
            <div class="form-group">
                <label>@lang('site.provenances') </label>
                 <select name="provenance_id" class="form-control ">
                     ...
                     <option value="{{$item->id}}" {{$product->provenance_id==$item->id ?'selected':''}} > {{$item->title}}</option>
                     @endforeach
                 </select>
             </div>
            {{-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="spicail_pag" class="form-control ">
                    <option {{$product->spicail_pag=='not_active'?'selected':''}} value="not_active">@lang('site.not_active')</option>
                    <option {{$product->spicail_pag=='active'?'selected':''}} value="active">@lang('site.active')</option>
                </select>
             </div>
   ...
   <div class="form-group">
       ...
       <textarea name="expiration" id="" class="form-control"  cols="30" rows="10">{{$product->expiration}}</textarea>
    </div>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <select required="required" name="status" id="" class="form-control">
                    <option {{$product->status=='not_active'?'selected':''}} value="not_active">@lang('site.not_active')</option>
