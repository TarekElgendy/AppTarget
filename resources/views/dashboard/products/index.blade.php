                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{$product->image_path}}" style="width: 100px;" class="img-thumbnail">
                                  ...
                                  <td>
                                 <span class="  btn-{{$product->stock_status=="AvailableOfStock"?'success':'warning'}} btn-sm "> ( {{$product->stock_count}} ) {{ __('site.'.$product->stock_status) }}</span>
                            </td>


                            <td>
                                <a href="{{ route('dashboard.additions.index',[
                                    'product_id'=>$product->id
                                ]) }}" class="btn btn-success btn-sm {{$section_edit=='close'?'hidden':''}}"><i
                                        class="fa fa-cock"></i> {{$product->additions->count()}}</a>


                            </td>
                               <td>
                                <a href="{{ route('dashboard.productWeights.index',[ 'search'=>$product->id
                                ]) }}" class="btn btn-warning btn-sm {{$section_edit=='close'?'hidden':''}}"><i
                                        class="fa fa-cock"></i> {{$product->productWeights->count()}}</a>
                            </td>
                            ...
                            <td>
                                <a href="{{ route('dashboard.instructions.index',[
                                    'product_id'=>$product->id
                                ]) }}" class="btn btn-danger btn-sm {{$section_edit=='close'?'hidden':''}}"><i
                                        class="fa fa-cock"></i> {{$product->instructions->count()}}</a>
