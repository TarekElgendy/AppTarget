...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('site.sections')</li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title" style="margin-bottom: 15px">@lang('site.sections')
                    <small>
                ...
                <table class="table table-hover" id="data_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ $section->image_path }}" style="width: 100px; background-color:black" class="img-thumbnail" alt="">
                            </td>
                            <td><img src="{{ $section->icon_path }}" style="width: 100px; background-color:black" class="img-thumbnail" alt="">
                            </td>
                            <td>
                                @if (auth()->user()->hasPermission('update_sections'))
                                    <a href="{{ route('dashboard.sections.duplicate', $section->id) }}"
