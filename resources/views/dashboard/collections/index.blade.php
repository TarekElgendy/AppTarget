...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('site.collections')</li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title" style="margin-bottom: 15px">@lang('site.collections')
                    <small>
                        @lang('site.total_search')
                        ( {{  count($collections) }} )
                    </small></h3>
                <form action="{{ route('dashboard.collections.index') }}" method="get">
                    <div class="row">
                        ...
                        <div class="col-md-4 {{$section_add=='close'?'hidden':''}}">
                            @if (auth()->user()->hasPermission('create_collections'))
                            <a href="{{ route('dashboard.collections.create') }}" class="btn btn-primary"><i
                ...
                <table class="table table-hover" id="data_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{ $collection->price }} KWD  </td>
                            {{-- <td> {{ $collection->description }}</td> --}}
                            <td><img src="{{ $collection->image_path }}" style="width: 100px;" class="img-thumbnail" alt="">
                            </td>
                            <td>
                                @if (auth()->user()->hasPermission('update_collections'))
                                <!--<a href="{{ route('dashboard.collections.duplicate', $collection->id) }}"-->
                                <!--    class="btn btn-warning btn-sm {{$section_edit=='close'?'hidden':''}}"><i-->
                                <!--        class="fa fa-copy"></i> @lang('site.duplicate')</a>-->
                                <a href="{{ route('dashboard.collections.edit', $collection->id) }}"
                                ...
                                <a href="#" class="btn btn-info btn-sm disabled"><i class="fa fa-edit"></i>
                                    @lang('site.edit')</a>
                                @endif
                                @if (auth()->user()->hasPermission('delete_collections'))
