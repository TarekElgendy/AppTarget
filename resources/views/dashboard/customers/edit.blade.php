                    ...
                    <form action="{{ route('dashboard.customers.update',$customer->id ) }}"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>@lang('site.dateOfBirth')</label>
                                    <input required="required"  type="date" name="dateOfBirth" class="form-control"  value="{{$customer->dateOfBirth}}"  >
                                </div>
                                
                                 
                                <div class="form-group">
                                    <label>lat</label>
                                    <input readonly type="number" name="lat" class="form-control"  value="{{$customer->lat}}"  >
                                </div>
                                <div class="form-group">
                                    <label>lng</label>
                                    <input readonly type="number" name="lng" class="form-control"  value="{{$customer->lng}}"  >
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="customer_address" readonly col="12" row="3"  class="form-control">{{$customer->customer_address}}</textarea>
                                </div>
                                 <div class="form-group">
                                    <label>@lang('site.city')</label>
                                    <input readonly type="number" name="city_id" class="form-control"  value="{{$customer->city_id}}"  >
                                </div>
                                <div class="form-group">
 
                                    <label>@lang('site.state')</label>
                                    <input readonly type="number" name="state_id" class="form-control"  value="{{$customer->state_id}}"  >
                                </div>
                                
                                <div class="form-group">
                                    <label></label>
                                    <select name='status' class="form-control"   required >
                                        <option value="1"  {{$customer->status=='1'?'selected':''}} >@lang('site.Active')</option>
                                        <option value="2"  {{$customer->status=='2'?'selected':''}} >@lang('site.In-Active')</option>
