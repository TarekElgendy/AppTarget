                ...
                @if ($customers->count() > 0)
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- <td>
                            <a href="{{ url('dashboard/orders?customer_id=')}}{{$customer->id}}" class="btn btn-success
                            btn-sm"><i class="fa fa-edit"></i> @lang('site.orders') ( ) </a>
                            </td> --}}
                            ...
                            <!--<td><img src="{{ $customer->image_path }}" style="width: 100px;" class="img-thumbnail" alt="">-->
                            <!--</td>-->
                            <td>

                                @if (auth()->user()->hasPermission('update_customers'))
                                <a href="{{ route('dashboard.customers.edit', $customer->id) }}"
                                    class="btn btn-info btn-sm {{$section_edit=='close'?'hidden':''}}" ><i class="fa fa-edit"></i> @lang('site.edit')</a>
                                @else
